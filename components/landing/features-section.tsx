...
const features = [
  {
    number: "01",
    title: "Cloud Security Audit & Hardening",
    description: "Comprehensive assessment of your cloud infrastructure. We identify misconfigurations, exposed resources, and compliance gaps across AWS, Azure, and GCP.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Cloud Penetration Testing",
    description: "Real-world attack simulations targeting your cloud environment. Our certified ethical hackers test your defenses and provide actionable remediation paths.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Secure Cloud Migration",
    description: "Plan and execute cloud migrations without security compromises. We ensure data protection, compliance, and zero-trust architecture from day one.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Incident Response & Recovery",
    description: "24/7 incident response services. When breaches happen, we contain, investigate, and recover with minimal downtime and data loss.",
    visual: "security",
  },
];
...
function FeatureCard({ feature, index, isLast }: { feature: typeof features[0]; index: number; isLast: boolean }) {
  ...
  return (
    ...
    >
      <div className={`flex flex-col lg:flex-row gap-8 lg:gap-16 py-8 lg:py-12 ${isLast ? "" : "border-b border-foreground/10"}`}>
        {/* Number */}
...
export function FeaturesSection() {
  ...
  return (
    <section
      id="services"
      ref={sectionRef}
      className="relative pt-24 lg:pt-32 pb-12 lg:pb-16"
    >
      <div className="max-w-[1400px] mx-auto px-8 lg:px-16">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            ...
            <br />
            <span className="text-muted-foreground">Audits to incident response.</span>
          </h2>
        </div>
        ...
        <div>
          {features.map((feature, index) => (
            <FeatureCard key={feature.number} feature={feature} index={index} isLast={index === features.length - 1} />
          ))}
        </div>
      </div>
    </section>
