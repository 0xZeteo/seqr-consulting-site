...
pnpm add @seqr/sdk`,
  ...
  {
    label: "Initialize",
    code: `import { SEQR } from '@seqr/sdk'

const seqr = new SEQR({
  apiKey: process.env.SEQR_API_KEY
})`,
  },
  {
    label: "Audit",
    code: `const report = await seqr.audit({
  cloud: 'aws',
  regions: 'all',
...
export function DevelopersSection() {
  ...
  return (
    <section id="developers" ref={sectionRef} className="relative py-32 lg:py-40 overflow-hidden">
